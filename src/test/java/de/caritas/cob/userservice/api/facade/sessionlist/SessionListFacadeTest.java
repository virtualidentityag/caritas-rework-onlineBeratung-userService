...
class SessionListFacadeTest {
  ...
  @Test
  void retrieveSessionsForAuthenticatedUser_Should_ReturnCorrectlySortedSessionList() {
    ...
    for (UserSessionResponseDTO dto : result.getSessions()) {
      ...
      if (nonNull(dto.getSession())) {
        assertThat(previousDate).isLessThanOrEqualTo(dto.getSession().getMessageDate());
      } else {
        assertThat(previousDate).isLessThanOrEqualTo(dto.getChat().getMessageDate());
      }
    }
  }

  @Test
  void retrieveSessionsForAuthenticatedConsultant_Should_ReturnCorrectlySortedSessionList() {
  ...
  @Test
  void retrieveSessionsForAuthenticatedConsultant_Should_ReturnCorrectOffset() {
